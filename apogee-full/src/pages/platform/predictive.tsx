      ...
      <div className="max-w-[900px] mx-auto px-5 sm:px-8">
        <Animate delay={100} direction="up">
          ...
          <p className="text-white/70 text-[17px] sm:text-[19px] leading-relaxed mb-10">
            Detailed overview of Predictive Models capabilities within Apogee. This page is ready for product content, screenshots, and technical deep-dives.
          </p>
        </Animate>
        ...
        <Animate delay={250} direction="up">
          <div className="space-y-6 text-white/60 text-[15px] leading-relaxed">
            <p>
              Apogee's Predictive Models helps teams turn essential data into actionable intelligence.
